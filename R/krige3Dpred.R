...
#fun=As.fun; reg.pred=IntP.As; profs=bor.profs; model = FALSE; krige = FALSE; v.cutoff=60; v.width=3; sp.vgm = vgm(1200, "Sph", 2000, 300);v.vgm = vgm(250, "Gau", 30, 5); sp.cutoff=4000; sp.width=480
